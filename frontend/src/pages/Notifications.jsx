...
import { Bell, Check, Clock, CreditCard, CalendarCheck } from "lucide-react";
...
export default function Notifications() {
  ...
  return (
    <div className="min-h-[calc(100vh-90px)] bg-[#F8F6F0] px-6 py-12">
      <div className="mx-auto max-w-[1000px]">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div>
            ...
            <p className="mt-2 text-[#6F7B89]">
              Stay updated about your bookings and payments.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="px-6 py-20 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-[#7A8491]">
                Your booking updates, acceptance messages and payment
        ...
        <button
          ...
          className="mt-6 text-sm font-semibold text-[#0B2742] transition hover:text-[#C6922E]"
        >
          ← Back to My Bookings
        </button>
